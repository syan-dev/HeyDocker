...
def get_telegram_allowed_ids():
    ...
    # if environ var empty, check ~/.heydocker/credentials
    if allowed_ids is None and os.path.exists(os.path.expanduser("~/.heydocker/credentials")):
        config = configparser.ConfigParser()
        config.read(os.path.expanduser("~/.heydocker/credentials"))
...
def get_openai_endpoint():
    ...
    # if environ var empty, check ~/.heydocker/credentials
    if endpoint is None and os.path.exists(os.path.expanduser("~/.heydocker/credentials")):
        config = configparser.ConfigParser()
        config.read(os.path.expanduser("~/.heydocker/credentials"))
